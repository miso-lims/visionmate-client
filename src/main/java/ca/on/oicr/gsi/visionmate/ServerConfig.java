...
public class ServerConfig {
  ...
  /**
   * gets the current setting of a character that is appended to the end of every response from the server
   * 
   * @return the current setting
   */
  ...
  /**
   * sets a character that is appended to the end of every response from the server. This character is required for detecting the end 
   * of output
   * 
  ...
  /**
   * gets the current delimiter setting. This is the character that separates barcodes returned from the Get Data command
   * 
   * @return the current setting
   */
  ...
  /**
   * gets the text command for the Get Current Product command, used to check the currently configured rack type
   * 
   * @return the command
   */
  ...
  /**
   * sets the text command for the Get Current Product command, used to check the currently configured rack type
   * 
   * @param command
   */
  ...
  /**
   * sets the text command for the Set Current Product operation, used to configure the rack type to scan
   * 
  ...
  /**
   * gets the String that will be used in place of a barcode when there is no tube present in the position
   * 
   * @return the String
   */
  ...
  /**
   * sets the String that will be used in place of a barcode when there is no tube present in the position
   * 
   * @param noTubeLabel
   */
  ...
  /**
   * gets the String that will be used in place of a barcode when there is a tube present in the position, but the scanner failed to 
   * read its barcode
   * 
   * @return the String
   */
  ...
  /**
   * sets the String that will be used in place of a barcode when there is a tube present in the position, but the scanner failed to 
   * read its barcode
   * 
   * @param noReadLabel
   */
  ...
  /**
   * gets the currently configured sort order, which may be by row (A1, A2, B1, B2) or column (A1, B1, A2, B2)
   * 
   * @return the order
   */
